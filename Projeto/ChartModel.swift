    ...
    var body: some View{
        ...
        VStack {
            ...
            Chart(tipos) { tipo in
                ...
                tipos = [
                    .init(tipo: "Fazer", porcentagem: tarefas.filter { $0.tipo == "Fazer" }.count, cor: Color.blue),
                    .init(tipo: "Fazendo", porcentagem: tarefas.filter { $0.tipo == "Fazendo" }.count, cor: Color.green),
                    .init(tipo: "Feito", porcentagem: tarefas.filter { $0.tipo == "Feito" }.count, cor: Color.yellow),
                ]})
...
struct Achievement: View{
    ...
    var body: some View{
        ...
        if(tarefasFeitas>=valor){
            ...
            .background(LinearGradient(colors: [Color .yellow.opacity(0.6), Color .clear], startPoint: .bottom, endPoint: .top))
            .background(.blue)
            .cornerRadius(100)
            .padding()
            .shadow(radius: 10)
