...
class ViewModel: ObservableObject {
    ...
    func post(_ obj: DadosTarefa){
        ...
        guard let url = URL(string: "http://192.168.128.116:1880/postDados") else { return } //Aqui deve ser colocado o IP (local ou da rede) e, depois da barra, o verbo do POST do Node-RED
