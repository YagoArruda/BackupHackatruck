    ...
    var body: some View{
        ...
        VStack {
            ...
            Chart(tipos) { tipo in
                ...
                tipos = [
                    .init(tipo: "Fazer", porcentagem: tarefas.filter { $0.tipo == "Fazer" }.count, cor: Color.manha),
                    .init(tipo: "Fazendo", porcentagem: tarefas.filter { $0.tipo == "Fazendo" }.count, cor: Color.tarde),
                    .init(tipo: "Feito", porcentagem: tarefas.filter { $0.tipo == "Feito" }.count, cor: Color.noite),
                ]})
